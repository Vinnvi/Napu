...
final class Version20210312120021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE match_day (id INT AUTO_INCREMENT NOT NULL, league_id INT NOT NULL, number INT NOT NULL, INDEX IDX_E1EE884E58AFC4DE (league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE league ADD CONSTRAINT FK_3EB4C318AC78BCF8 FOREIGN KEY (sport_id) REFERENCES sport (id)');
        $this->addSql('ALTER TABLE match_day ADD CONSTRAINT FK_E1EE884E58AFC4DE FOREIGN KEY (league_id) REFERENCES league (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE match_day DROP FOREIGN KEY FK_E1EE884E58AFC4DE');
